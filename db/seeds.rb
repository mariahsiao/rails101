...
puts "這個種子檔會自動建立一個帳號, 並創建 20 個 groups, 每個 group 各 30 個 posts"

create_account = User.create([email: 'test@gmail.com', password:'11223344', password_confirmation:'11223344', name:'測試用帳號！'])
